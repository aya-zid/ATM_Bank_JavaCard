...
public class Debiter extends JFrame implements ActionListener{

	private Tansactions transactions;
    JLabel l1;
    JButton b1,b2,b3,b4,b5,b6,b7,b8;
    Debiter(Tansactions transactions){
        ...
        l1 = new JLabel("SELECTIONNER LA QUANTITE A DEBITER");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        r=Login.a.debitAmount(amount);
     	...
     	{
     		JOptionPane.showMessageDialog(null, "Success: Amount Debited ");
     	}
